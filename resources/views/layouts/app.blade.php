                ...
                <ul class="nav navbar-nav">                    
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/department/create') }}">Add Department</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/facility/create') }}">Add Facility</a></li>
                                <li><a href="{{ url('/facility') }}">View Facility</a></li>
                            </ul>
                        </li>  
                    @endif
                </ul>
